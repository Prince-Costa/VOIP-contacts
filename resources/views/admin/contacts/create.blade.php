            ...
            <form action="{{ route('contacts.store') }}" method="POST" class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control border border-primary" placeholder="Enter Contact Name" value="{{ old('name') }}">
                            @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="email" name="email1" id="email1" class="form-control border border-primary" placeholder="Enter Contact email1" value="{{ old('email1') }}">
                            @error('email1')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="email" name="email2" id="email2" class="form-control border border-primary"  placeholder="Enter Contact email2" value="{{ old('email2') }}">
                            @error('email2')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="phone_number" id="phone_number" class="form-control border border-primary" placeholder="Enter Contact phone number" value="{{ old('phone_number') }}">
                            @error('phone_number')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                {{--<div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="role" id="role" class="form-select border border-primary" required>
